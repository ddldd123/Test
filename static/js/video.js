...
(function() {
	...
	t.c = function(a, c, d) {
		...
		e.W || (e.disabled = l, e.W = function(c) {
			if(!e.disabled) {
				...
				var d = e.C[c.type];
				if(d)
					for(var d = d.slice(0), j = 0, n = d.length; j < n && !c.zc(); j++) d[j].call(a, c)
			}
		});
			...
			if(e.C) {
				...
				if(c) {
					...
					if(g) {
						if(d) {
							if(d.r)
								for(e = 0; e < g.length; e++) g[e].r === d.r && g.splice(e--, 1)
						} else e.C[c] = [];
						t.kc(a, c)
					}
				} else
					for(g in e.C) c = g, e.C[c] = [], t.kc(a, c)
			}
		}
	};
	t.kc = function(a, c) {
	...
	var ba = t,
		z;
	var A = t.O.match(/Android (\d+)(?:\.(\d+))?(?:\.(\d+))*/i),
		B, C;
	...
	s.dispose = function() {
		...
		if(this.P)
			for(var a = this.P.length - 1; 0 <= a; a--) this.P[a].dispose && this.P[a].dispose();
	...
	s.Z = function(a) {
		if(37 == a.which || 40 == a.which) a.preventDefault(), this.Nc();
		else if(38 == a.which || 39 == a.which) a.preventDefault(), this.Oc()
	};
	s.Xa = function() {
		t.j(document, "keyup", t.bind(this, this.Z))
	};
	...
	s.xa = function() {
		...
		if(this.Q = this.createItems())
			for(var c = 0; c < this.Q.length; c++) ca(a, this.Q[c]);
		return a
	};
	s.wa = m();
	s.T = function() {
	...
	s.exitFullscreen = function() {
		...
		else this.o.Ea() ? T(this, "exitFullScreen") : (this.Cb(), this.l("fullscreenchange"));
		return this
	};
	...
	s.src = function(a) {
		...
		t.g.isArray(a) ? U(this, a) : "string" === typeof a ? this.src({
			src: a
		}) : a instanceof Object && (a.type && !window.videojs[this.eb].canPlaySource(a) ? U(this, [a]) : (this.G.src = a.src, this.nc = a.type || "", this.K(function() {
			T(this, "src", a.src);
	...
	s.xa = function() {
		var a = new t.ha(this.k()),
			c = this.k().options().playbackRates;
		if(c)
			for(var d = c.length - 1; 0 <= d; d--) a.V(new t.nb(this.k(), {
				rate: c[d] + "x"
			}));
		return a
	};
	...
	t.f = t.q.extend({
		i: function(a, c, d) {
			...
			e && (e.type && t.f.Gd(e.type) ? (e = t.f.Pc(e.src), j.rtmpConnection = encodeURIComponent(e.wb), j.rtmpStream = encodeURIComponent(e.Rb)) : j.src = encodeURIComponent(t.tc(e.src)));
			t.Hb(g, d);
	...
	s.update = function() {
		if(0 < this.ca.length) {
			...
			if(this.Pb === b || a < this.Pb || this.Wa <= a) {
				...
				for(;;) {
					r = c[w];
					if(r.ya <= a) e = Math.max(e, r.ya), r.Na && (r.Na = l);
					else if(a < r.startTime) {
						if(d = Math.min(d, r.startTime), r.Na && (r.Na = l), !g) break
					} else g ? (h.splice(0, 0, r), n === b && (n = w), j = w) : (h.push(r), j === b && (j = w), n = w), d = Math.min(d, r.ya), e = Math.max(e, r.startTime), r.Na = f;
					if(g)
						if(0 === w) break;
						else w--;
	...
	t.U.prototype.wa = function() {
		...
		for(var d = 0; d < this.d.textTracks().length; d++) c = this.d.textTracks()[d], c.M() === this.H && a.push(new t.aa(this.d, {
			track: c
		}));
		return a
	};
	...
	s.wa = function() {
		for(var a = [], c, d = 0; d < this.d.textTracks().length; d++) c = this.d.textTracks()[d], c.M() === this.H && a.push(new t.aa(this.d, {
			track: c
		}));
		return a
	};
	s.xa = function() {
		for(var a = this.d.textTracks(), c = 0, d = a.length, e, g, h = this.Q = []; c < d; c++)
			if(e = a[c], e.M() == this.H)
				if(0 === e.readyState()) e.load(), e.c("loaded", t.bind(this, this.xa));
				else {
					g = e;
					break
				}
		...
		t.JSON.parse = function(a, c) {
			function d(a, e) {
				...
				if(r && "object" === typeof r)
					for(j in r) Object.prototype.hasOwnProperty.call(r, j) && (n = d(r, j), n !== b ? r[j] = n : delete r[j]);
				return c.call(a, e, r)
			}
			var e;
			a = String(a);
